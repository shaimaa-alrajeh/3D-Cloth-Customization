...
const GirlsShirt = () => {
  ...
  const { nodes, materials } = useGLTF('/regular_loose_fit_unisex_cardigan_design.glb');

  // تحميل الصور لتطبيقها على النموذج
